  ...
  return (
    <div className='' id="about" ref={aboutRef}>
        <div className="lg:px-20 xl:px-32 2xl:px-64 px-7 py-5 lg:py-24">
            <div className=''>
                <span className='bg-gradient-to-r from-castleton to-emerald text-transparent bg-clip-text text-2xl lg:text-5xl font-black'>ABOUT ME</span>
            </div>

            <div className='py-5 lg:py-10'>
                <p className='text-sm lg:text-xl'>
                    Greetings! I am <b className='text-emerald'>Mark Ian Amado</b>, a dedicated <b className='text-emerald'>Full Stack Software Engineer</b> with expertise in HTML, CSS, JavaScript, React, Tailwind, Material-UI, Ruby, Ruby on Rails, PHP and Laravel.
